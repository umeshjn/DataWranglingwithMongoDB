"""
This code will iteratively parse the file and clean the street types for maintaining the consistency in the state name entries throughout.

Below are problems with street types handled by this code:
Street types are not mentioned with the same consistency. There are lot of entires with different formats for street types:
