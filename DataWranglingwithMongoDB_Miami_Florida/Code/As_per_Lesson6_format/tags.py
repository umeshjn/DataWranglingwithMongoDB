...
import re
"""
This code will check the "k" value for each "<tag>" and 
see if they can be valid keys in MongoDB,
as well as see if there are any other potential problems.

3 regular expressions will check for certain patterns in the tags.
"""
